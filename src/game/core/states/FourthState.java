...
public class FourthState extends BasicState {
	...
	public void createContent(GameContainer gc, StateBasedGame game)
		...
		sb.addLabel(1, 0.5f, 0.5f,
				"Customize your profile, track your stats and achievements.");
		...
		menu = sb.getPane(-1);
		menu.setBackground(MoreColors.getTrans(Color.gray.darker(0.15f), 0.1f),
				Color.red.darker(0.9f));

		menu.addButton(10, 5, new Image("resources/parts/state4/button0.png")
				.getScaledCopy(menuButtonsScale));
		...
		menu.addButton(10, 50, new Image("resources/parts/state4/button1.png")
				.getScaledCopy(menuButtonsScale));
		menu.getComponent(-1).addListener(new ComponentListener() {
		...
		menu.addButton(10, 95, new Image("resources/parts/state4/button2.png")
				.getScaledCopy(menuButtonsScale));
		menu.getComponent(-1).addListener(new ComponentListener() {
		...
		menu.addButton(10, 140, new Image("resources/parts/state4/button3.png")
				.getScaledCopy(menuButtonsScale));
		menu.getComponent(-1).addListener(new ComponentListener() {
		...
		menu.addButton(10, 185, new Image("resources/parts/state4/button4.png")
				.getScaledCopy(menuButtonsScale));
		menu.getComponent(-1).addListener(new ComponentListener() {
